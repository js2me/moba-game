    ...
    return (
      <header className={`header ${this.context.router.route.location.pathname == '/' && 'current-page-is-root'}`}>
        ...
        <div className='routes'>
          <NavLink className='routerLink' exact={true} activeClassName='routerLinkActive' to="/">home</NavLink>
          <NavLink className='routerLink' activeClassName='routerLinkActive' to="/game">game</NavLink>
